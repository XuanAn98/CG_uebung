...
public class Mat3x3 {
	...
	final double m32;
	final double m33;
	final double determinatnte;
	

	public Mat3x3(double m11, double m12, double m13, double m21, double m22, double m23, double m31, double m32,
			double m33) {
		...
		double x = m11 * ((m22 * m33) - (m32 * m23));
		double y = -m12 * ((m12 * m33) - (m31 * m23));
		double z = m13 * ((m21 * m32) - (m22 * m31));

		this.determinatnte = x + y + z;
	...
	public Mat3x3 changeCol1(Vector3 v) {
		Mat3x3 change = new Mat3x3(v.x, m12, m13, v.y, m22, m23, v.z, m32, m33);
		return change;

	}

	public Mat3x3 changeCol2(Vector3 v) {
		Mat3x3 change = new Mat3x3(m11, v.x , m13, m21, v.y, m23, m31, v.z, m33);
		return change;

	}

	public Mat3x3 changeCol3(Vector3 v) {
		Mat3x3 change = new Mat3x3(m11, m12 ,v.x , m21, m22, v.y, m31, m32, v.z);
		return change;
